...
function createSensorCard(sensorId, videoInfo) {
    ...
    card.innerHTML = `
        ...
        <div>
            ...
            ${videoInfo ? `
                <button class="button preview" onclick="showPreview('${videoInfo.video_path}')">
                    Ver Preview
                </button>
...
function createPlaylistItem(video, isFirst, isLast) {
    ...
    div.innerHTML = `
        ...
        <div class="playlist-controls">
            <button class="button" onclick="showPreview('${video.video_path}')">Preview</button>
...
// Control del Debug Panel
function toggleDebugPanel() {
    const currentState = localStorage.getItem('debugEnabled') === 'true';
